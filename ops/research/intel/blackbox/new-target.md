# intel/new-target — blackbox.ai

## Goal
Produce a complete competitive-intel brief on blackbox.ai and convert findings into Aiki-relevant opportunities.
...
Output artifact: `ops/now/intel/blackbox/research.md`
...
Output artifact: `ops/now/intel/blackbox/aiki-map.md`
...
Output artifact: `ops/now/intel/blackbox/opportunities.md`
...
Output artifact: `ops/now/intel/blackbox/followups.md`

## Deliverable
`ops/now/intel/blackbox/brief.md` containing:
