# intel/new-target — Ampcode CLI launch

## Goal
Produce a competitive-intel brief on the Ampcode “Towards a New CLI” post and convert findings into Aiki-relevant opportunities.

## Target
- Name: Ampcode
- URL: https://ampcode.com/news/towards-a-new-cli
- GitHub: unknown (discover during research)
...
- Product/news page and docs
- Blog/changelog context
- Public repo(s) and org page (if any)
- Public demos/videos/social threads where behavior is shown

Output artifact: `ops/now/intel/ampcode/research.md`
...
Output artifact: `ops/now/intel/ampcode/aiki-map.md`
...
Output artifact: `ops/now/intel/ampcode/opportunities.md`
...
Output artifact: `ops/now/intel/ampcode/followups.md`

## Deliverable
`ops/now/intel/ampcode/brief.md` containing:
