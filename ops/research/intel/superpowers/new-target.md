# intel/new-target — Superpowers

## Goal
Produce a complete competitive-intel brief on Superpowers and convert findings into Aiki-relevant opportunities.
...
Output artifact: `ops/now/intel/superpowers/research.md`
...
Output artifact: `ops/now/intel/superpowers/aiki-map.md`
...
Output artifact: `ops/now/intel/superpowers/opportunities.md`
...
Output artifact: `ops/now/intel/superpowers/followups.md`

## Deliverable
`ops/now/intel/superpowers/brief.md` containing:
