# intel/new-target — usegitai.com

## Goal
Produce a complete competitive-intel brief on UseGitAI and convert findings into Aiki-relevant opportunities.
...
Output artifact: `ops/now/intel/usegitai/research.md`
...
Output artifact: `ops/now/intel/usegitai/aiki-map.md`
...
Output artifact: `ops/now/intel/usegitai/opportunities.md`
...
Output artifact: `ops/now/intel/usegitai/followups.md`

## Deliverable
`ops/now/intel/usegitai/brief.md` containing:
