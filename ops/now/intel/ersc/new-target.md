# intel/new-target — ersc.io

## Goal
Produce a complete competitive-intel brief on ERSC and convert findings into Aiki-relevant opportunities.
...
Output artifact: `ops/now/intel/ersc/research.md`
...
Output artifact: `ops/now/intel/ersc/aiki-map.md`
...
Output artifact: `ops/now/intel/ersc/opportunities.md`
...
Output artifact: `ops/now/intel/ersc/followups.md`

## Deliverable
`ops/now/intel/ersc/brief.md` containing:
