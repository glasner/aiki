# intel/new-target — tastematter.dev

## Goal
Produce a complete competitive-intel brief on TasteMatter and convert findings into Aiki-relevant opportunities.
...
Output artifact: `ops/now/intel/tastematter/research.md`
...
Output artifact: `ops/now/intel/tastematter/aiki-map.md`
...
Output artifact: `ops/now/intel/tastematter/opportunities.md`
...
Output artifact: `ops/now/intel/tastematter/followups.md`

## Deliverable
`ops/now/intel/tastematter/brief.md` containing:
